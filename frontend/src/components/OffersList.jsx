...
const OffersList = ({ searchQuery = '' }) => {
  ...
  .filter((offer) => {
    const name = offer.name?.[preferredLanguage] || offer.name?.en || '';
          ...
          >
            ...
            {offer.partnerId && (
              <div className="flex items-center text-xs text-gray-500 mb-2">
                ...
                <span>
                  {offer.partnerId.businessName || offer.partnerId.firstName || 'Business'}
                </span>
              </div>
            )}
            ...
            {isExpanded && (
              <div className="mt-4 text-center">
                <p className="text-xs text-gray-500 mb-1">
                  {t('map.showThisCode', 'Show this QR code to redeem the offer')}
                </p>
                <img
